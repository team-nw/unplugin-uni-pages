import type { Conditional } from '@babel/types'
import type { LoadConfigSource } from 'unconfig'
import type { EasyCom } from './easycom'
import type { GlobalStyle } from './globalStyle'
import type { PageMetaOption, SubPackageMetaOption } from './page'
...
export interface SubPageOption extends PageOption {
  root: string
}
...
export interface Options {
  ...
  pages?: string | PageOption
  subPackage?: string[] | SubPageOption[]
...
export interface PagesConfig {
   ...
   * @desc H5 不支持
   */
  subPackages?: SubPackageMetaOption[]
